...
---  For Oracle, run:  alter session set NLS_DATE_FORMAT='YYYY-MM-DD';
---  For Oracle, escape ampersands with a leading backslash
---  For SQL Server, remove commit statements
---  For DB2, change date strings to MM/DD/YY format
---  added deletes to allow re-runs
